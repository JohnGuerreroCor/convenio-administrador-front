...
export class ConvenioComponent {
  ...
  registrarFormulario(): void {
    this.dialogRef = this.dialog.open(ModalFormularioConvenio, {
      width: '70%',
      disableClose: true,
    });
...
@Component({
  selector: 'modal-formulario-convenio',
  templateUrl: 'modal-formulario-convenio.html',
  styleUrls: ['./convenio.component.css'],
  providers: [
    {
...
export class ModalFormularioConvenio {
  ...
  constructor(
    public dialogRef: MatDialogRef<ModalFormularioConvenio>,
  ...
  registrarInstitucio(institucion: any) {
